// =========================================================================
// 🎯 AQUI É O ONDE VOCÊ VAI COLAR SEU CÓDIGO GIGANTE
// Substitua o objeto de teste abaixo mantendo o ponto e vírgula no final!
// =========================================================================
const dadosDoJson = {
  ...
  "items": [
    ...
    },
    {
      ...
      "iconUrls": {
        ...
        "heroMedium": "https://api-assets.clashroyale.com/cardheroes/300/X_DQUye_OaS3QN6VC9CPw05Fit7wvSm3XegXIXKP--0.png"
      },
      "rarity": "common"
    },
    {
    ...
    },
    {
      ...
      "iconUrls": {
        ...
        "heroMedium": "https://api-assets.clashroyale.com/cardheroes/300/qBipxLo-3hhCnPrApp2Nn3b2NgrSrvwzWytvREev0CY.png"
      },
      "rarity": "epic"
    },
    {
    ...
    },
    {
      ...
      "iconUrls": {
        ...
        "heroMedium": "https://api-assets.clashroyale.com/cardheroes/300/0lIoYf3Y_plFTzo95zZL93JVxpfb3MMgFDDhgSDGU9A.png",
    ...
    },
    {
      ...
      "iconUrls": {
        ...
        "heroMedium": "https://api-assets.clashroyale.com/cardheroes/300/Mej7vnv4H_3p_8qPs_N6_GKahy6HDr7pU7i9eTHS84U.png",
    ...
    },
    {
      ...
      "iconUrls": {
        ...
        "evolutionMedium": "https://api-assets.clashroyale.com/cardevolutions/300/Wyjq5l0IXHTkX9Rmpap6HaH08MvjbxFp1xBO9a47YSI.png"
      },
      "rarity": "common"
    },
    {
    ...
    },
    {
      ...
      "iconUrls": {
        ...
        "evolutionMedium": "https://api-assets.clashroyale.com/cardevolutions/300/bAwMcqp9EKVIKH3ZLm_m0MqZFSG72zG-vKxpx8aKoVs.png"
      },
      "rarity": "legendary"
    },
    {
      ...
      "iconUrls": {
        ...
        "heroMedium": "https://api-assets.clashroyale.com/cardheroes/300/M7fXlrKXHu2IvpSGpk36kXVstslbR08Bbxcy0jQcln8.png"
      },
      "rarity": "epic"
    },
    {
    ...
    },
    {
      ...
      "iconUrls": {
        ...
        "heroMedium": "https://api-assets.clashroyale.com/cardheroes/300/SU4qFXmbQXWjvASxVI6z9IJuTYolx4A0MKK90sTIE88.png"
      },
      "rarity": "epic"
    },
    {
    ...
    },
    {
      ...
      "iconUrls": {
        ...
        "heroMedium": "https://api-assets.clashroyale.com/cardheroes/300/r05cmpwV1o7i7FHodtZwW3fmjbXCW34IJCsDEV5cZC4.png"
      },
      "rarity": "rare"
    },
    {
      ...
      "iconUrls": {
        ...
        "heroMedium": "https://api-assets.clashroyale.com/cardheroes/300/-T_e4YLbuhPBKbYnBwQfXgynNpp5eOIN_0RracYwL9c.png"
      },
      "rarity": "rare"
    },
    {
    ...
    },
    {
      ...
      "iconUrls": {
        ...
        "heroMedium": "https://api-assets.clashroyale.com/cardheroes/300/Avli3W7BxU9HQ2SoLiXnBgGx25FoNXUSFm7OcAk68ek.png"
      },
      "rarity": "legendary"
    },
    {
    ...
    },
    {
      ...
      "iconUrls": {
        ...
        "heroMedium": "https://api-assets.clashroyale.com/cardheroes/300/NA6W8S1JBYBlOPwD3dNvJLFvVDKq-UuBs_J3i3ewLFI.png"
      },
      "rarity": "common"
    },
    {
    ...
    },
    {
      ...
      "elixirCost": 5,
      "iconUrls": {
        "medium": "https://api-assets.clashroyale.com/cards/300/X0dTFs7OGUavreDEzOtYd_YNZ8Zly6qgAE-dd-bNfWU.png"
      },
      "rarity": "legendary"
    },
    {
    ...
    },
    {
      ...
      "iconUrls": {
        ...
        "heroMedium": "https://api-assets.clashroyale.com/cardheroes/300/LjSfSbwQfkZuRJY4pVxKspZ-a0iM5KAhU8w-a_N5Z7Y.png"
      },
      "rarity": "rare"
    },
    {
    ...
    },
    {
      ...
      "iconUrls": {
        ...
        "heroMedium": "https://api-assets.clashroyale.com/cardheroes/300/Gb0G1yNy0i5cIGUHin8uoFWxqntNtRPhY_jeMXg7HnA.png"
      },
      "rarity": "epic"
    },
    {
...
// A partir daqui, é a lógica que faz o site funcionar:
let todasAsCartas = dadosDoJson.items || dadosDoJson
...
// Renderizar Cartas
function renderizarCartas(listaDeCartas) {
  const container = document.getElementById('cartas-container');
  container.innerHTML = '';

  if (!listaDeCartas || listaDeCartas.length === 0) {
    container.innerHTML = '<p>Nenhuma carta encontrada.</p>';
    return;
  }

  // 1. ORDENAÇÃO: Organiza do elixir 1 ao mais pesado (9)
  const cartasOrdenadas = [...listaDeCartas].sort((a, b) => {
    const elixirA = a.elixirCost ?? a.elixir ?? 99;
    const elixirB = b.elixirCost ?? b.elixir ?? 99;
    return elixirA - elixirB;
  });

  // 2. AGRUPAMENTO: Separa as cartas por quantidade de elixir
  const grupos = {};
  cartasOrdenadas.forEach(carta => {
    const elixir = carta.elixirCost ?? carta.elixir ?? 'Especial';
    if (!grupos[elixir]) grupos[elixir] = [];
    grupos[elixir].push(carta);
  });

  // 3. RENDERIZAÇÃO: Cria uma divisão bonita para cada elixir
  Object.keys(grupos).forEach(elixir => {
    const blocoGrupo = document.createElement('div');
    blocoGrupo.classList.add('grupo-elixir');

    const titulo = document.createElement('div');
    titulo.classList.add('titulo-elixir');
    
    if (isNaN(elixir)) {
      titulo.innerHTML = `<span>Cartas Especiais / Táticas</span>`;
    } else {
      titulo.innerHTML = `<span class="icone-elixir">${elixir}</span> <span>Elixir</span>`;
    }
    
    blocoGrupo.appendChild(titulo);

    const gridCartas = document.createElement('div');
    gridCartas.classList.add('container');

    grupos[elixir].forEach(carta => {
      const cardElement = document.createElement('div');
      cardElement.classList.add('carta-card');

      const nome = carta.name || carta.nome || 'Carta';
      const custoElixir = carta.elixirCost ?? carta.elixir ?? 'N/A';
      
      let imagem = 'https://royaleapi.github.io/cr-api-assets/cards/unknown.png';
      if (carta.iconUrls && carta.iconUrls.medium) {
        imagem = carta.iconUrls.medium;
      } else if (carta.imagem) {
        imagem = carta.imagem;
      }

      cardElement.innerHTML = `
        <img src="${imagem}" alt="${nome}" onerror="this.src='https://royaleapi.github.io/cr-api-assets/cards/unknown.png'">
        <h3>${nome}</h3>
        <p>Elixir: ${custoElixir}</p>
      `;

      gridCartas.appendChild(cardElement);
    });

    blocoGrupo.appendChild(gridCartas);
...
if (inputBusca) {
  inputBusca.addEventListener('input', (e) => {
    ...
    // Se o campo estiver vazio, mostra todas as cartas organizadas
    if (termo === '') {
      renderizarCartas(todasAsCartas);
      return;
    }

    // Filtra as cartas pelo nome
    const cartasFiltradas = todasAsCartas.filter(c => {
      const nome = c.name || c.nome || '';
      return nome.toLowerCase().includes(termo);
    });

    // Se não encontrar nenhuma carta
    if (cartasFiltradas.length === 0) {
      container.innerHTML = `
        <div style="text-align: center; margin-top: 40px; width: 100%;">
          <div style="font-size: 3rem; margin-bottom: 10px;">❌</div>
          <h2 style="color: #ff4d4d; margin-bottom: 5px;">Carta não encontrada!</h2>
          <p style="color: #a0a0b8;">Não existe nenhuma carta chamada "<strong>${e.target.value}</strong>".</p>
        </div>
      `;
      return;
    }

    // Se encontrar, mostra as cartas filtradas por elixir
